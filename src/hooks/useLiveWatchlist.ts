...
import { apiClient, type MarketBar1m } from '@/api/client';
  ...
  useEffect(() => {
    const fetchSparklines = async () => {
      ...
      try {
        ...
        // Fetch last ~6 bars per symbol (backend should support batching).
        const data = (await apiClient.getMarketData1mLatest({
          symbols,
